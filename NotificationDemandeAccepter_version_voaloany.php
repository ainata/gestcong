...
<div id="content_container">
		<div id="content">
			...
			mysql_query($mamova);
					...
					$req="select * from valider,deposition where valider.ID_DEPOSITION=deposition.ID_DEPOSITION and deposition.ID_EMPLOYER=".$_SESSION['id']." and VALIDE_DEPARTEMENT = 'oui' and VALIDE_RESPONSABLE = 'oui' order by DATE_DE_DEMANDE DESC";
					...
					if($resultat)
					{
						while($ligne=mysql_fetch_array($resultat))
						{
                           ...
                           <div class="div_accept" style="border:1px solid #CCCCCC;border-radius:5px;padding:10px; box-shadow:5px 5px 5px #CCCCCC;">
                            <div><span style="color:#00CCFF;">Vous avez déposé le demande le :</span>
							<?php 
